        ...
        <section id="services" className="relative py-24 md:py-40 px-6">
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-20">
                    ...
                    >
                        <span className="text-[10px] font-black uppercase tracking-[0.3em] text-neutral-500 mb-4 block">System Capabilities</span>
                        <h2 className="text-4xl md:text-6xl font-black tracking-tighter leading-none mb-8 text-black uppercase">
                            Autonomous <br className="md:hidden" />
                            Talent <span className="text-neutral-400 italic px-2">Layer</span>
                        </h2>
                    </motion.div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 md:grid-rows-2 gap-6 h-auto md:h-[800px]">
                    ...
                    <div className="md:col-span-2 md:row-span-2 glass-panel p-10 rounded-3xl relative overflow-hidden group">
                        <div className="absolute top-0 right-0 p-8 text-neutral-300 opacity-20 group-hover:scale-110 transition-transform duration-500">
                            <Cpu size={120} />
                        </div>
                        <div className="relative z-10 h-full flex flex-col justify-end">
                            <Zap className="w-12 h-12 text-black mb-6" />
                            <h3 className="text-3xl font-black text-black mb-4 uppercase tracking-tighter">Neural Talent Matching</h3>
                    ...
                    <div className="md:col-span-2 md:row-span-1 glass-panel p-10 rounded-3xl relative overflow-hidden group">
                         <div className="absolute top-0 right-0 p-8 text-neutral-300 opacity-20 group-hover:rotate-12 transition-transform duration-500">
                            <Shield size={80} />
                        </div>
                        <div className="relative z-10 flex flex-col h-full">
                            <h3 className="text-2xl font-black text-black mb-4 uppercase tracking-tighter">Automated Screening</h3>
                    ...
                    <div className="md:col-span-1 md:row-span-1 glass-panel p-8 rounded-3xl relative overflow-hidden group">
                        <div className="relative z-10 flex flex-col h-full items-start justify-center">
                            <Network className="w-8 h-8 text-neutral-600 mb-4" />
                            <h3 className="text-lg font-black text-black mb-2 uppercase tracking-tight">Global Mesh</h3>
                    ...
                    <div className="md:col-span-1 md:row-span-1 bg-black text-white p-8 rounded-3xl relative overflow-hidden group border border-neutral-800">
